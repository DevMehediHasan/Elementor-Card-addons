...
class Flip_Box extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Flip Box', 'first-card-widget' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Front', 'first-card-widget' ),
			]
		);

		$this->start_controls_tabs( 'side_a_content_tabs' );

		$this->start_controls_tab( 'side_a_content_tab', [ 'label' => esc_html__( 'Content', 'first-card-widget' ) ] );

		$this->add_control(
			'graphic_element',
			[
				'label' => esc_html__( 'Graphic Element', 'first-card-widget' ),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'none' => [
						'title' => esc_html__( 'None', 'first-card-widget' ),
						'icon' => 'eicon-ban',
					],
					'image' => [
						'title' => esc_html__( 'Image', 'first-card-widget' ),
						'icon' => 'eicon-image-bold',
					],
					'icon' => [
						'title' => esc_html__( 'Icon', 'first-card-widget' ),
						'icon' => 'eicon-star',
					],
				],
				'default' => 'icon',
		...
		$this->add_control(
			'selected_icon',
			[
				'label' => esc_html__( 'Icon', 'first-card-widget' ),
		...
		$this->add_control(
			'icon_view',
			[
				'label' => esc_html__( 'View', 'first-card-widget' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'default' => esc_html__( 'Default', 'first-card-widget' ),
					'stacked' => esc_html__( 'Stacked', 'first-card-widget' ),
					'framed' => esc_html__( 'Framed', 'first-card-widget' ),
				],
				'default' => 'default',
				'condition' => [
					'graphic_element' => 'icon',
		...
		$this->add_control(
			'icon_shape',
			[
				'label' => esc_html__( 'Shape', 'first-card-widget' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'circle' => esc_html__( 'Circle', 'first-card-widget' ),
					'square' => esc_html__( 'Square', 'first-card-widget' ),
				],
				'default' => 'circle',
				'condition' => [
					'icon_view!' => 'default',
		...
		$this->add_control(
			'title_text_a',
			[
				'label' => esc_html__( 'Title & Description', 'first-card-widget' ),
				'type' => Controls_Manager::TEXT,
				'default' => esc_html__( 'This is the heading', 'first-card-widget' ),
		...
		$this->add_control(
			...
			[
				...
				'default' => esc_html__( 'Lorem ipsum dolor sit amet consectetur adipiscing elit dolor', 'first-card-widget' ),
		...
		$this->start_controls_tab( 'side_a_background_tab', [ 'label' => esc_html__( 'Background', 'first-card-widget' ) ] );
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Background Overlay', 'first-card-widget' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Blend Mode', 'first-card-widget' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'' => esc_html__( 'Normal', 'first-card-widget' ),
					'multiply' => 'Multiply',
					'screen' => 'Screen',
					'overlay' => 'Overlay',
					'darken' => 'Darken',
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Back', 'first-card-widget' ),
			]
		);

		$this->start_controls_tabs( 'side_b_content_tabs' );

		$this->start_controls_tab( 'side_b_content_tab', [ 'label' => esc_html__( 'Content', 'first-card-widget' ) ] );
		...
		$this->add_control(
			'button_text',
			[
				'label' => esc_html__( 'Button Text', 'first-card-widget' ),
				'type' => Controls_Manager::TEXT,
				'default' => esc_html__( 'Click Here', 'first-card-widget' ),
				'dynamic' => [
					'active' => true,
				],
				'separator' => 'before',
		...
		$this->add_control(
			'link_click',
			[
				'label' => esc_html__( 'Apply Link On', 'first-card-widget' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'box' => esc_html__( 'Whole Box', 'first-card-widget' ),
					'button' => esc_html__( 'Button Only', 'first-card-widget' ),
				],
				'default' => 'button',
				'condition' => [
					'link[url]!' => '',
		...
		$this->start_controls_tab( 'side_b_background_tab', [ 'label' => esc_html__( 'Background', 'first-card-widget' ) ] );
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Settings', 'first-card-widget' ),
			]
		);
		...
		$this->add_responsive_control(
			'height',
			[
				'label' => esc_html__( 'Height', 'first-card-widget' ),
		...
		$this->add_control(
			'border_radius',
			[
				'label' => esc_html__( 'Border Radius', 'first-card-widget' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%' ],
				'range' => [
					'px' => [
		...
		$this->add_control(
			'flip_effect',
			[
				'label' => esc_html__( 'Flip Effect', 'first-card-widget' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'flip',
				'options' => [
					'flip' => 'Flip',
		...
		$this->add_control(
			'flip_direction',
			[
				'label' => esc_html__( 'Flip Direction', 'first-card-widget' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'up',
				'options' => [
					'left' => esc_html__( 'Left', 'first-card-widget' ),
					'right' => esc_html__( 'Right', 'first-card-widget' ),
					'up' => esc_html__( 'Up', 'first-card-widget' ),
					'down' => esc_html__( 'Down', 'first-card-widget' ),
				],
				'condition' => [
					'flip_effect!' => [
						'fade',
		...
		$this->add_control(
			'flip_3d',
			[
				'label' => esc_html__( '3D Depth', 'first-card-widget' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'On', 'first-card-widget' ),
				'label_off' => esc_html__( 'Off', 'first-card-widget' ),
		...
		$this->add_responsive_control(
			'padding_a',
			[
				'label' => esc_html__( 'Padding', 'first-card-widget' ),
		...
		$this->add_control(
			'vertical_position_a',
			[
				'label' => esc_html__( 'Vertical Position', 'first-card-widget' ),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'top' => [
						'title' => esc_html__( 'Top', 'first-card-widget' ),
						'icon' => 'eicon-v-align-top',
					],
					'middle' => [
						'title' => esc_html__( 'Middle', 'first-card-widget' ),
						'icon' => 'eicon-v-align-middle',
					],
					'bottom' => [
						'title' => esc_html__( 'Bottom', 'first-card-widget' ),
		...
		$this->add_control(
			'image_spacing',
			[
				'label' => esc_html__( 'Spacing', 'first-card-widget' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
		...
		$this->add_control(
			'image_width',
			[
				'label' => esc_html__( 'Size', 'first-card-widget' ) . ' (%)',
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ '%' ],
				'default' => [
					'unit' => '%',
		...
		$this->add_control(
			'image_opacity',
			[
				'label' => esc_html__( 'Opacity', 'first-card-widget' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 1,
				],
		...
		$this->add_control(
			'icon_primary_color',
			[
				'label' => esc_html__( 'Primary Color', 'first-card-widget' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Secondary Color', 'first-card-widget' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'condition' => [
					'graphic_element' => 'icon',
		...
		$this->add_control(
			'icon_size',
			[
				'label' => esc_html__( 'Icon Size', 'first-card-widget' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 6,
		...
		$this->add_control(
			'icon_padding',
			[
				'label' => esc_html__( 'Icon Padding', 'first-card-widget' ),
				'type' => Controls_Manager::SLIDER,
				'selectors' => [
		...
		$this->add_control(
			'icon_rotate',
			[
				'label' => esc_html__( 'Icon Rotate', 'first-card-widget' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 0,
					'unit' => 'deg',
		...
		$this->add_control(
			'icon_border_width',
			[
				'label' => esc_html__( 'Border Width', 'first-card-widget' ),
				'type' => Controls_Manager::SLIDER,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				...
				'default' => 'sm',
				'options' => [
					'xs' => esc_html__( 'Extra Small', 'first-card-widget' ),
					'sm' => esc_html__( 'Small', 'first-card-widget' ),
					'md' => esc_html__( 'Medium', 'first-card-widget' ),
					'lg' => esc_html__( 'Large', 'first-card-widget' ),
					'xl' => esc_html__( 'Extra Large', 'first-card-widget' ),
				],
				'condition' => [
					'button_text!' => '',
				],
		...
		$this->add_control(
			'button_border_color',
			[
				'label' => esc_html__( 'Border Color', 'first-card-widget' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
